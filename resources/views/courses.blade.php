        ...
        <div class="space-y-12">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-yellow-50 rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-l-4 border-blue-900 animate-fade-in-up group">
                <div class="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3 group-hover:text-blue-900 transition-colors duration-300">1. Business & Management</h3>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-blue-50 rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-l-4 border-yellow-500 animate-fade-in-up-delay group">
                <div class="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3 group-hover:text-blue-900 transition-colors duration-300">2. Information Technology (IT) & Computer Science</h3>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-yellow-50 rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-l-4 border-blue-900 animate-fade-in-up-delay group">
                <div class="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3 group-hover:text-blue-900 transition-colors duration-300">3. Health & Allied Health</h3>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-blue-50 rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-l-4 border-yellow-500 animate-fade-in-up-delay group">
                <div class="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3 group-hover:text-blue-900 transition-colors duration-300">4. Engineering</h3>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-yellow-50 rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-l-4 border-blue-900 animate-fade-in-up-delay group">
                <div class="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3 group-hover:text-blue-900 transition-colors duration-300">5. Hospitality & Tourism</h3>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-t-4 border-blue-900 animate-fade-in-up group">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-900 transition-colors duration-300">1. Automotive</h3>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-t-4 border-yellow-500 animate-fade-in-up-delay group">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-900 transition-colors duration-300">2. Carpentry & Construction</h3>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-center hover:text-blue-900 hover:translate-x-2 transition-all duration-300">
                        <svg class="w-4 h-4 text-yellow-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-t-4 border-blue-900 animate-fade-in-up-delay group">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-900 transition-colors duration-300">3. Plumbing</h3>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-center hover:text-blue-900 hover:translate-x-2 transition-all duration-300">
                        <svg class="w-4 h-4 text-yellow-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-t-4 border-yellow-500 animate-fade-in-up-delay group">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-900 transition-colors duration-300">4. Electrical Trades</h3>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-center hover:text-blue-900 hover:translate-x-2 transition-all duration-300">
                        <svg class="w-4 h-4 text-yellow-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-t-4 border-blue-900 animate-fade-in-up-delay group">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-900 transition-colors duration-300">5. Engineering Trades</h3>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-center hover:text-blue-900 hover:translate-x-2 transition-all duration-300">
                        <svg class="w-4 h-4 text-yellow-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border-t-4 border-yellow-500 animate-fade-in-up-delay group">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-900 transition-colors duration-300">6. Hair & Beauty</h3>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-center hover:text-blue-900 hover:translate-x-2 transition-all duration-300">
                        <svg class="w-4 h-4 text-yellow-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
